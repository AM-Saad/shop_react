...
const Product = () => {
    ...
    const { currentProduct, productsMeta, fetch_product, updatingMeta, delete_product } = adminCtx
        ...
        return (
            <div className="p-4 sm:p-6">
                <div className='flex items-center justify-between'>
                    ...
                    {currentProduct && !updatingMeta.loading && <button onClick={() => { setOpenConfirmDeleteModal(true) }} className=' py-2 px-4 text-sm bg-red-400 rounded hover:opacity-70 text-white' > Delete </button>}
